...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener,
    ...
    private void enableLocationUpdates() {
        ...
        //setInterval() Ejecuta una función o un fragmento de
        // código de forma repetitiva cada vez que termina el
        // periodo de tiempo determinado
        locRequest.setInterval(1000);
        //Es el tiempo en que se va a volver a actualizar la ubicacion
        locRequest.setFastestInterval(8000);
        //con el setPriority le desimos que queremos informacion nitida hasta con un error  de unos 100 mtros
